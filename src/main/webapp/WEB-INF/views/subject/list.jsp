													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu" role="menu"
															...
															<li role="presentation"><a role="menuitem"
																tabindex="-1"
																href="${pageContext.request.contextPath}/subject/${subject.id}/edit">Edit</a></li>
															<li role="presentation"><a role="menuitem"
																tabindex="-1"
																href="${pageContext.request.contextPath}/subject/${subject.id}/delete">Delete</a></li>
														</ul>
													</div>
												</c:otherwise>
											</c:choose></td>
